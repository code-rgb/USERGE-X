...
FONT_FLAGS = ["-serif", "-sans", "-sans_i", "-serif_i", "-medi_b", "-medi", "-double", "-cursive_b", "-cursive", "-small", "-reverse", "-circle", "-circle_f", "-mono", "-square", "-square_f", "-wide", "-web", "-weeb", "-weeeb"]
...
@userge.on_cmd("style", about={
    ...
    "-small", "-reverse", "-circle", "-circle_f", "-mono", 
    "-square", "-square_f", "-wide", "-web", "-weeb", "-weeeb"]})
