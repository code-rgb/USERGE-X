...
FONT_FLAGS = ['-serif', '-sans', '-sans_i', '-serif_i', '-medi_b', '-medi',
              '-double', '-cursive_b', '-cursive', '-bigsmall', '-reverse',
              '-circle', '-circle_b', '-mono', '-square_b', '-square',
              '-smoth', '-goth', '-wide', '-web', '-weeb', '-weeeb']
...
async def _style_text(message: Message):
    ...
    if message.flags:
        ...
        flag_choice = rand_array(FONT_FLAGS)
        input_str = args
