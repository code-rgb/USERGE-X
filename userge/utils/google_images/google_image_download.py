...
class googleimagesdownload:
    ...
    def _get_next_item(self, s):
        ...
        try:
            ...
            final_object = ujson.loads(object_decode)
        except BaseException:
            final_object = ""
    ...
    def _get_image_objects(self, s):
        ...
        return ujson.loads(object_decode[:-15])[31][0][12][2]
    ...
    def download(self, arguments):
        ...
        if __name__ != "__main__":
            ...
            if "config_file" in arguments:
                records = []
                json_file = ujson.load(open(arguments["config_file"]))
                ...
                for i in range(len(search_keyword)):  # 3.for every main keyword
                    ...
                    if arguments["extract_metadata"]:
                        ...
                        with open(
                            ...
                            ujson.dump(items, json_file, indent=4, sort_keys=True)
                    # Related images
